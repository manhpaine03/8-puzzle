...
namespace A_BFS
{
	class State
	{
		...
		//Trả về danh sách danh sách, mỗi danh sách đại diện cho một trạng thái kế tiếp
		...
		//Trả về danh sách các đối tượng State đại diện cho các trạng thái kế tiếp
